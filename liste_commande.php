...
<ul class="nav nav-pills nav-stacked">
  ...
  <li class="active"><a href="#"> <i class="fa fa-calendar"></i> Toutes vos commandes <span class="label label-warning pull-right r-activity">
    <?php
...
<div class="row">
<div class="panel">
<div style="margin: 10px 350px 30px 350px"> </div>
                            <center>
                                <table class="table">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <?php
                                        // Sélectionner les lignes de la table "commande" pour l'utilisateur courant
                                        $query = "SELECT img, nom_produit, prix, quantite, heure FROM commande WHERE utilisateur = '$user'";
                                        $result = mysqli_query($con, $query);

                                        // Afficher les données dans le tableau
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            echo "<tr>";
                                            echo '<td><img class="img-fluid" width="50" src="img/' . $row['img'] . '"></td>';
