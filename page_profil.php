...
<li><a href="liste_commande.php"> <i class="fa fa-calendar"></i> Toutes vos commandes <span class="label label-warning pull-right r-activity"><?php
    ...
    ?></span></a></li>
<li><a href="modif_profil.php"> <i class="fa fa-edit"></i>Aide</a></li>
</ul>
</div>
</div>
...
<p><span>EMail :</span><?php
    // Assurez-vous que $user_id contient l'ID de l'utilisateur connecté

    // Effectuez la requête SQL pour récupérer l'e-mail de l'utilisateur
    $query = "SELECT mail FROM user WHERE id = '$user'";
...
<div class="bio-row">
<p><span>Mot de passe :</span><?php
    // Assurez-vous que $user_id contient l'ID de l'utilisateur connecté

    // Effectuez la requête SQL pour récupérer l'e-mail de l'utilisateur
    $query = "SELECT mdp FROM user WHERE id = '$user'";
    $result = $con->query($query);
...
<div class="bio-row">
<p><span>validité :</span>oui</p>
</div>
<div class="bio-row">
<p><span>Poste de travail :</span><?php
    // Assurez-vous que $user_id contient l'ID de l'utilisateur connecté

    // Effectuez la requête SQL pour récupérer l'e-mail et le poste de l'utilisateur
    $query = "SELECT poste FROM user WHERE id = '$user'";
    $result = $con->query($query);
