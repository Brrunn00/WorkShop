      ...
      <div   class="video-overlay header-text">
          ...
          <div class="caption">
            ...
            <br>
						...
						<br>
							<button>
								<i id='submit' type="submit" class="spinner"></i>
								<span id='submit' type="submit">connexion</span>
							</button>
							<?php
                if (isset($erreur)) {
              ...
              <div class="main-button">
                  <div class="scroll-to-section"><a href="index.html">Retour à l'acceuil</a></div>
              </div>
          </div>
		 </div>
  </section>
